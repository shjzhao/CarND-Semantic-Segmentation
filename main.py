...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # upsample
    vgg_layer7_upsample = tf.layers.conv2d_transpose(vgg_layer7_conv,
                                                     num_classes,
                                                     4,
                                                     strides=(2, 2),
                                                     padding='same',
    ...
    # upsample
    layer3 = tf.layers.conv2d_transpose(layer4,
                                        num_classes,
                                        4,
                                        strides=(2, 2),
                                        padding='same',
    ...
    vgg_layer3_conv = tf.layers.conv2d(vgg_layer3_out,
                                       num_classes,
                                       1,
                                       padding='same',
                                       kernel_initializer=tf.random_normal_initializer(stddev=0.01),
    ...
    # upsample
    output = tf.layers.conv2d_transpose(layer3,
                                        num_classes,
                                        16,
                                        strides=(8, 8),
                                        padding= 'same',
